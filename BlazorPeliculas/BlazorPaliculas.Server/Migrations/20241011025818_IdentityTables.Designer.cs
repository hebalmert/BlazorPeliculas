...
namespace BlazorPaliculas.Server.Migrations
{
    ...
    [Migration("20241011025818_IdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorPeliculas.Shared.Entidades.GeneroCls", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorPeliculas.Shared.Entidades.Peliculas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorPeliculas.Shared.Entidades.GeneroPelicula", b =>
                {
                    b.HasOne("BlazorPeliculas.Shared.Entidades.GeneroCls", "Genero")
                        .WithMany("GenerosPelicula")
                        .HasForeignKey("GeneroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorPeliculas.Shared.Entidades.Peliculas", "Peliculas")
                        .WithMany("GenerosPelicula")
            ...
            modelBuilder.Entity("BlazorPeliculas.Shared.Entidades.PeliculaActor", b =>
                {
                    ...
                    b.HasOne("BlazorPeliculas.Shared.Entidades.Peliculas", "Pelicula")
                        .WithMany("PeliculasActor")
